  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-sidebar px-6 py-12">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <p className="mt-2 font-mono text-xs uppercase tracking-widest text-sidebar-foreground/40">
          AI Agent Workspace
        </p>

        <div className="mt-10 rounded-2xl border border-white/10 bg-white/[0.04] p-7 shadow-xl backdrop-blur-sm">
